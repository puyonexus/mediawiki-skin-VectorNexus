...
/**
 * QuickTemplate class for Vector Nexus skin
 * @ingroup Skins
 */
class VectorNexusTemplate extends BaseTemplate {
	/* Functions */
	...
	public function execute() {
		...
		?>
		<header id="pn-header" class="noprint">
			<nav id="pn-navbar">
				<div class="container">
		...
		<?php /*<div id="mw-page-base" class="noprint"></div>
...
<?php
	...
	protected function renderPortal( $name, $content, $msg = null, $hook = null ) {
		...
		?>
		<div class="vectorMenu" role="navigation" id='<?php
		echo Sanitizer::escapeId( "p-$name" )
		?>'<?php
		echo Linker::tooltip( 'p-' . $name )
		?> aria-labelledby='<?php echo $labelId ?>'>
			<h3<?php $this->html( 'userlangattributes' ) ?> id='<?php echo $labelId ?>'><span><?php
